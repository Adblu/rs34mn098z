...
classifier.add(Dense(8, activation='sigmoid',  input_dim=X.shape[1]))
...
classifier.add(Dense(64, activation='sigmoid', kernel_initializer='random_uniform'))
classifier.add(Dense(32, activation='sigmoid', kernel_initializer='random_uniform'))
classifier.add(Dense(16, activation='sigmoid', kernel_initializer='random_uniform'))
classifier.add(Dense(Y.shape[1], activation='sigmoid', kernel_initializer='random_uniform'))
